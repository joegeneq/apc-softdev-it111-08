...
if (DPCalendarHelper::isJoomlaVersion('3.2'))
{
	...
	<div class="row-fluid">
		<div class="span12 form-horizontal">
			<ul class="nav nav-tabs">
				...
				<li><a href="#location" data-toggle="tab" onclick="updateLocationFrame();"><?php echo JText::_('COM_DPCALENDAR_FIELD_LOCATION_LABEL') ?></a></li>

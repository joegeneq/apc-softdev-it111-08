...
if (isset($attribs['name']) && $attribs['name'] == 'user3') {
    ...
    echo '<ul class="za-hmenu' . $class_sfx . '"' . $tag . '>';
    ...
    echo '</ul>';
} else if (0 === strpos($params->get('moduleclass_sfx'), 'za-vmenu') || false !== strpos($params->get('moduleclass_sfx'), ' za-vmenu')) {
    $menutype = 'vertical';

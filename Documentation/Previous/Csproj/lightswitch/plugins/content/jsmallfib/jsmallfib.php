...
/**
* @version $Id$
* @package Joomla! 1.6.x, JSmallfib plugin
* @copyright (c) 2009-2012 Enrico Sandoli
		...
		if ($log_email_from && $log_email_to)
		{
                        ...
                        if ($log_type != LOG_TYPE_TEXT)
                        {
                            ...
                            if ($this->params->def('mail_in_html_mode', 1))
                            {
                                ...
                                $logtext  .= strlen($log_text_array['new_element']) ? "<tr><td><strong>".JText::_('log_new_element_label').":</strong></td><td>".$log_text_array['new_element']."</td></tr>" : "";
...
//			."	width: 100px;"
		...
		//	."	width:40%;"//.($this->table_width - 380)."px;"
			...
			."	text-align:center;"
			."	width:1px;" // we don't put 0 here as Safari seems to take it as 'no fixed width'
			."	padding:".$this->icon_padding."px;"
			."}	"

...
if (JFactory::getApplication()->get('jquery')) $upload_jquery = 1;



if ($upload_jquery == 0) {
	if ($upload_jqueryinclude == 0)
		$document->addScript( $sfu_basepath."tmpl/jquery-".$upload_jqueryver.".min.js" );
	else
		echo '<script type="text/javascript" src="'.$sfu_basepath.'tmpl/jquery-".$upload_jqueryver.".min.js"></script>';
	// Set jQuery loaded for other extensions
...
// wait till the DOM is loaded
	...
	jQuery(document).ready(function() {
		...
		<?php if ($upload_jqueryver === "1.4.3") {
			echo "jQuery('#sfu_AChkCredentials".$mid."').live('click', function() {";
		} else {
			echo "jQuery(document).on('click', '#sfu_AChkCredentials".$mid."', function() {";
		} ?>
		...
		<?php if ($upload_jqueryver === "1.4.3") {
			echo "jQuery('#sfu_AChkCaptcha".$mid."').live('click', function() {";
		} else {
			echo "jQuery(document).on('click', '#sfu_AChkCaptcha".$mid."', function() {";
		} ?>
		...
		//jQuery(document).on('click', '#sfu_AKillSession<?php echo $mid ?>', function() {
		<?php if ($upload_jqueryver === "1.4.3") {
			echo "jQuery('#sfu_AKillSession".$mid."').live('click', function() {";
		} else {
			echo "jQuery(document).on('click', '#sfu_AKillSession".$mid."', function() {";
		} ?>

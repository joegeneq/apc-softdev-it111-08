...
{
  $style = isset($attribs['artstyle']) ? $attribs['artstyle'] : 'za-nostyle';
  $styles = array(
    'za-nostyle' => 'modChrome_artnostyle',
    'za-block' => 'modChrome_artblock',
    'za-article' => 'modChrome_artarticle',
    'za-vmenu' => 'modChrome_artvmenu'
  );
  ...
  //  'za-...'        - overwrites the default module style.
  //  'suffix za-...' - overwrites the default style and adds suffix to the module and
  //                     to its elements, does not add za-... to the module elements.
...
<!-- begin nostyle -->
<div class="za-nostyle<?php echo $params->get('moduleclass_sfx'); ?>">

...
class MURL extends MObject{
	...
	static function _($setView = null, $setDir= null, $setTask = null, $postFix= null){		
	...
	static function _global($setView = null, $setDir= null, $setTask = null, $postFix= null){
	...
	static function safePath($path = null){
